...
def rgb_decompose(image):
    ...
    axis[1][0].hist(red.ravel(), bins=256, range=(1, 256), color='red')
    axis[1][1].hist(green.ravel(), bins=256, range=(1, 256), color='green')
    axis[1][2].hist(blue.ravel(), bins=256, range=(1, 256), color='blue')
